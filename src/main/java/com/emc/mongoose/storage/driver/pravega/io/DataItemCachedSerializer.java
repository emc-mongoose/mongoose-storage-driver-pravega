...
public class DataItemCachedSerializer<I extends DataItem>
	 ...
	 */
	public DataItemCachedSerializer(final boolean useDirectMem, final I anyDataItem) {
		this.useDirectMem = useDirectMem;
		this.serializedValue = internalSerialize(anyDataItem);
	}
	...
	//called once for the first event
	public final ByteBuffer internalSerialize(final I dataItem)
